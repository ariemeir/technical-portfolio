...
//use following macros if SS (PB3) pin is used for Chip Select of SD
//#define SD_CS_ASSERT     PORTB &= ~0x08
//#define SD_CS_DEASSERT   PORTB |= 0x08
#define SD_CS_ASSERT     PORTA &= ~0x08
#define SD_CS_DEASSERT   PORTA |= 0x08
